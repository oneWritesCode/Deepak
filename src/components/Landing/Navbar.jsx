    ...
    return (
        ...
        <div className='w-full min-h-[10vh] flex items-center justify-center'>
            <div className='w-full h-[100px] top-0 flex items-center justify-center z-40'>
                <div className='w-[80vw] p-4 flex justify-around items-center flex-wrap gap-10 mt-10 lg:mt-0'>

                    <div className='sm:text-2xl text-xl font-bold Bonheur'> {`< Codinnng />`}</div>
