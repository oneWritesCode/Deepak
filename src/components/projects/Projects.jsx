            ...
            <div className="w-full flex justify-center items-center flex-wrap mb-8 sm:mb-0">
              <ul className="italic text-gray-100 font-bold min-h-[20vh] sm:min-h-[30vh] mb-12 sm:mb-24 items-center flex flex-col w-full">
                ...
                <div className="pl-0 sm:pl-6 text-gray-200 flex gap-2 w-full flex-wrap justify-center">
                  ...
                  <Project image={FirstDesign} techStack={["Figma", "UI/UX"]} />
              ...
              <ul className="italic text-gray-100 font-bold min-h-[20vh] sm:min-h-[30vh] mb-12 sm:mb-24 items-center flex flex-col w-full">
                ...
                <div className="pl-0 sm:pl-6 text-gray-200 flex gap-2 w-full flex-wrap justify-center">
                  <Project
                    video={DMarts}
                    texts={[
                      "A website for B2B business which helps startups to make their strong digital performance so they can standout in market. build in 2024.",
                      "FREELANCE PROJECT",
                    ]}
                  ...
                  <Project
                    video={TypeZ}
                    texts={[
                      "A typing game website for peoples who want to improve their typing speed and accuracy.",
                    ]}
