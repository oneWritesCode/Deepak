...
function TechComponent(props) {
    return (
        <>
            ...
            {props.text &&
                <div className="p-2 border-gray-500 lg:h-[70px] h-[20px] backdrop-blur-xmd rounded-2xl shadow-xl shadow-white/10 bg-black/90 flex items-center justify-center">
                    <p
