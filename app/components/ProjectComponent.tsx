  ...
  return (
    <div className="w-full sm:max-w-xs md:max-w-sm lg:max-w-md p-2 sm:p-3 rounded-sm text-white flex flex-col items-center">
      ...
      <div className="relative w-full mb-4">
        {props.ytLink &&
          (() => {
            const url = new URL(props.ytLink);
            ...
            return (
              <iframe
                className="w-full min-w-50 md:min-w-100 h-42 sm:h-56 max-h-56 sm:max-h-64 rounded-md object-cover"
                src={url.toString()}
                frameBorder="0"
        ...
        {props.image && (
          <img
            ...
            className="w-full min-w-50 md:min-w-100 h-auto max-h-56 sm:max-h-64 rounded-lg object-cover border-2 border-white/20"
          />
        )}
