...
export default function Experience() {
  return (
    <div
      className="relative flex w-full h-full min-h-[75vh] items-center justify-between"
        ...
        <div className="flex items-start justify-between w-full">
          <div className="flex flex-col w-full relative">
            <div className="flex items-center w-full">
              <h1
                className="text-5xl md:text-6xl font-black uppercase tracking-tight text-black dark:text-white bg-[#f5f5f5] dark:bg-[#1a1a1a] z-1"
                style={{ fontFamily: "var(--font-anton)" }}
              >
                Experience
              </h1>
              {/* Horizontal line extending from text */}
              {/* <div className="hidden md:block flex-1 h-px bg-black/20 dark:bg-white/20"></div> */}
            </div>
            <span className="text-[10px] uppercase tracking-[0.25em] text-black/80 dark:text-white/60">
              Timeline
            </span>
            <p className="mt-2 text-[12px] leading-relaxed text-black/50 dark:text-white/50 max-w-[360px]">
